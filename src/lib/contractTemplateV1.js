...
<div class="page-content">
  ...
  <div class="sec-body" style="margin-bottom: 12px;">
    ...
    ${Number(data.start_of_construction_amount || 0) > 0 ? `<p>&#8226; ${data.start_of_construction_label || 'Upon completion and passing of framing and footer inspection:'} &nbsp;<strong>${money(data.start_of_construction_amount)}</strong></p>` : ""}
