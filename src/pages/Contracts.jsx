...
export default function Contracts() {
  ...
  const openFromBid = (b) => {
    ...
    const startConst = b.start_of_construction_amount || Math.round(bidAmount * 0.35 * 100) / 100;
    const finalPay = b.final_payment_amount || Math.round((bidAmount - depositAmt - startConst) * 100) / 100;
    ...
    setForm({
      ...
      start_of_construction_amount: startConst,
