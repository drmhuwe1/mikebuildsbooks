...
export default function Contracts() {
  ...
  const openFromBid = (b) => {
    const startOfConstruction = Math.round(b.bid_amount * 0.35 * 100) / 100;
    const finalPayment = Math.round((b.bid_amount - (b.deposit_amount || 0) - startOfConstruction) * 100) / 100;
