  ...
  const createContractMutation = useMutation({
    mutationFn: async (bidId) => {
      ...
      return base44.entities.Contract.create({
        ...
        payment_schedule: `Deposit: ${formatCurrency(bid.deposit_amount)} (${bid.deposit_percent}%) upon acceptance. Final: ${formatCurrency(bid.bid_amount - bid.deposit_amount)} upon completion.`,
        status: "draft",
      });
    },
    onSuccess: () => {
