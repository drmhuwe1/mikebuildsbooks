    ...
    <div className="space-y-4">
      ...
      <Dialog open={!!editingReceipt} onOpenChange={(open) => { if (!open) setEditingReceipt(null); }}>
        <DialogContent className="max-h-[90vh] flex flex-col gap-0">
          ...
          <div className="border-t pt-3 space-y-3 shrink-0 sticky bottom-0 bg-background">
            <div>
              <Label className="text-xs block mb-2">Receipt Photos</Label>
              <label className="flex items-center gap-2 border rounded-md px-3 py-2 cursor-pointer hover:bg-muted/50 transition-colors justify-center w-full">
                <Upload className="w-4 h-4" />
