...

{
  ...
  "deposit_percent": 50,
  "deposit_amount": 0,
  "deposit_condition": "Upon acceptance of contract",
  "start_of_construction_amount": 0,
  "start_of_construction_condition": "Upon start of construction",
  "final_payment_amount": 0,
  "final_payment_condition": "Upon final inspection and completion",
...
- Extract all Terms & Conditions section items including Unforeseen Conditions, Change Orders, Permits & Inspections, Weather Delays, and Site Access.`,
        ...
        response_json_schema: {
          ...
          properties: {
            ...
            deposit_condition: { type: "string" },
            start_of_construction_amount: { type: "number" },
            start_of_construction_condition: { type: "string" },
            final_payment_amount: { type: "number" },
            final_payment_condition: { type: "string" },
