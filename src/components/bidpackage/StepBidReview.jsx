  ...
  return (
    <div style={{ animation: "fadeUp 0.5s ease" }}>
        ...
        <div className="bp-card">
          ...
          <div style={{ background: "#fff", color: "#111", borderRadius: 12, padding: 32, fontFamily: "Georgia, serif" }}>
            ...
            <div style={{ marginTop: 32, paddingTop: 20, borderTop: "1px solid #ddd", fontSize: 11, color: "#999" }}>
              Prices are estimates based on current market rates and project analysis. Final costs may vary. Contractor signature required for binding agreement.
            </div>
          </div>
        </div>
      )}
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 16, flexWrap: "wrap" }}>
        ...
        <button className="bp-btn-secondary" onClick={handleDownloadSpecDrawings} disabled={generatingSpecs} style={{ marginLeft: "auto" }}>
          {generatingSpecs ? "⏳ Generating..." : "📐 Download Spec Drawings"}
        </button>
